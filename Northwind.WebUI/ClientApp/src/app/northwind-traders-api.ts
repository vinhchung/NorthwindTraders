...
export interface ICustomersClient {
    ...
    send(): Observable<FileResponse | null>;
    sendFile(): Observable<FileResponse | null>;
...
export class CustomersClient implements ICustomersClient {
    ...
    send(): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Customers/Send";
        url_ = url_.replace(/[?&]$/, "");
    ...
    sendFile(): Observable<FileResponse | null> {
        let url_ = this.baseUrl + "/api/Customers/SendFile";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSendFile(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendFile(<any>response_);
                } catch (e) {
                    return <Observable<FileResponse | null>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSendFile(response: HttpResponseBase): Observable<FileResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
